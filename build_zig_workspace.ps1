...
$exePath = Join-Path $outputDir 'wingui_demo_zig_workspace.exe'
$repoExePath = Join-Path $repoRoot 'demo_zig_workspace.exe'
$repoPdbPath = Join-Path $repoRoot 'demo_zig_workspace.pdb'
$outPdbPath = Join-Path $outputDir 'wingui_demo_zig_workspace.pdb'
...
Write-Host '==> Building wingui_demo_zig_workspace.exe'
